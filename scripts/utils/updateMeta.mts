...
const metaInfo = await fs.readFile("./meta/io.github.cootshk.Vesktop.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/io.github.cootshk.Vesktop.metainfo.xml", output, "utf-8");
